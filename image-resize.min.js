(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ImageResizeModule"] = factory(require("Quill"));
	else
		root["ImageResizeModule"] = factory(root["Quill"]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_quill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_left_svg__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg__ = __webpack_require__(112);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return alignAttribute; });
...
var leftAlignName = 'left';
var centerAlignName = 'center';
var rightAlignName = 'right';
var alignAttribute = 'data-align';

var AlignmentHelper = function () {
	function AlignmentHelper() {
		var _this = this;

		_classCallCheck(this, AlignmentHelper);
		...
		this.alignments = {
			left: {
				...
				apply: function apply(el) {
					return _this.applyLeftAlign(el);
				},
				isApplied: function isApplied(el) {
					return _this.isAligned(el, leftAlignName);
				}
			},
			center: {
				icon: __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg___default.a,
				apply: function apply(el) {
					return _this.applyCenterAlign(el);
				},
				isApplied: function isApplied(el) {
					return _this.isAligned(el, centerAlignName);
				}
			},
			right: {
				icon: __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg___default.a,
				apply: function apply(el) {
					return _this.applyRightAlign(el);
				},
				isApplied: function isApplied(el) {
					return _this.isAligned(el, rightAlignName);
				}
			}
		};
	}

	_createClass(AlignmentHelper, [{
		key: 'isAligned',
		value: function isAligned(el, alignType) {
			return this.alignAttribute.value(el) === alignType;
		}
	}, {
		key: 'applyLeftAlign',
		value: function applyLeftAlign(el) {
		...
		key: 'applyCenterAlign',
		value: function applyCenterAlign(el) {
		...
		key: 'applyRightAlign',
		value: function applyRightAlign(el) {
		...
		value: function getCurrentAlignment(el) {
			var _iteratorNormalCompletion = true;
			var _didIteratorError = false;
			var _iteratorError = undefined;

			try {
				for (var _iterator = this.getAlignments()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var alignment = _step.value;
...
/* harmony default export */ __webpack_exports__["a"] = (AlignmentHelper);
...
var DeleteHelper = function () {
	function DeleteHelper() {
		_classCallCheck(this, DeleteHelper);
	}

	_createClass(DeleteHelper, [{
		key: 'deleteBlot',
		value: function deleteBlot(el) {
			var blot = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.find(el);
			if (blot) {
				blot.deleteAt(0);
			}
		}
...
/* harmony default export */ __webpack_exports__["a"] = (DeleteHelper);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BaseModule__ = __webpack_require__(11);
...
var Toolbar = function (_BaseModule) {
	...
	_createClass(Toolbar, [{
		...
		value: function addToolbarButtons() {
			...
			var buttons = [];
			var alignmentHelper = this.options.alignmentHelper;
			alignmentHelper.getAlignments().forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					buttons.forEach(_this2.deselectButton);
					if (alignment.isApplied(_this2.img)) {
						if (_this2.options.toolbar.allowDeselect) {
							alignmentHelper.clear(_this2.img);
						} else {
							_this2.selectButton(button);
						}
					} else {
						// otherwise, select button and apply
						_this2.selectButton(button);
						alignment.apply(_this2.img);
					}
					// image may change position; redraw drag handles
					_this2.requestUpdate();
				});
				_this2.applyButtonStyle(button, idx);
				if (alignment.isApplied(_this2.img)) {
					// select button if previously applied
					_this2.selectButton(button);
				}
				_this2.toolbar.appendChild(button);
			});
		}
	}, {
		...
		value: function applyButtonStyle(button, idx) {
		...
		key: 'deselectButton',
		value: function deselectButton(button) {
...
var apply = __webpack_require__(21),
    ...
    customDefaultsMerge = __webpack_require__(69),
    mergeWith = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_quill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AlignmentHelper__ = __webpack_require__(10);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var IframeResize = function IframeResize(quill) {
    var _this = this;
    ...
    this.handleClick = function (evt) {
        var isImage = evt.target && evt.target.tagName && evt.target.tagName === 'IMG';
        if (!isImage || isImage && !_this.isProxyImage(evt.target)) {
            _this.removeProxyImages();
        }
    };

    this.handleInput = function (evt) {
        if (evt.keyCode === 46 || evt.keyCode === 8) {
            _this.deleteActiveIframes();
        }
    ...
    this.handleTextChange = function () {
        var iframes = Array.from(document.querySelectorAll(_this.options.iframeSelector));
        ...
        if (needsReindex) {
            iframes.forEach(function (iframe, index) {
                _this.removeMouseEnterListener(iframe);
                iframe.setAttribute(attributes.proxyId, 'iframe-proxy-' + index);
                _this.addMouseEnterListener(iframe);
            });
        }
    };

    this.handleVideoMouseEnter = function (evt) {
        var iframe = evt.target;
        var proxyImage = _this.getProxyImageForIframe(iframe);

        if (!proxyImage) {
            proxyImage = _this.createProxyImage(iframe);
        }

        _this.repositionProxyImage(proxyImage);
        document.body.appendChild(proxyImage);
        _this.observe(proxyImage);

        proxyImage.addEventListener('click', _this.getImageResize().handleClick, false);
    };

    this.handleProxyImageMutations = function (mutations) {
        mutations.forEach(function (mutation) {
            if (mutation.type !== 'attributes' || !mutation.target) {
                return;
            }

            var proxyImage = mutation.target;
            var iframe = _this.getIframeForProxyImage(proxyImage);

            _this.proxyImageObserver.disconnect();

            if (mutation.attributeName === 'width') {
                _this.onProxyImageWidthChange(proxyImage, iframe);
            } else if (mutation.attributeName === __WEBPACK_IMPORTED_MODULE_3__AlignmentHelper__["b" /* alignAttribute */]) {
                _this.onProxyImageAlignChange(proxyImage, iframe);
            }
    ...
    this.onProxyImageWidthChange = function (proxyImage, iframe) {
        iframe.height = proxyImage.height;
        iframe.width = proxyImage.width;
    };

    this.onProxyImageAlignChange = function (proxyImage, iframe) {
        var alignmentHelper = _this.getAlignmentHelper();
        var nextIframeAlignment = alignmentHelper.getCurrentAlignment(proxyImage);
        ...
        _this.repositionProxyImage(proxyImage);
        _this.getImageResize().repositionElements();
    };

    this.createProxyImage = function (iframe) {
        var canvas = _this.createProxyImageCanvas(iframe.getBoundingClientRect());
        var proxyImage = document.createElement('img');

        proxyImage.src = canvas.toDataURL('image/png');
        proxyImage.className = _this.options.proxyImageClass;
        proxyImage.setAttribute(attributes.proxyId, iframe.getAttribute(attributes.proxyId));

        return proxyImage;
    };

    this.createProxyImageCanvas = function (_ref) {
    ...
    this.repositionProxyImage = function (proxyImage) {
        var iframe = _this.getIframeForProxyImage(proxyImage);
        ...
        }, _this.options.proxyImageStyle);

        proxyImage.width = rect.width;
        _this.addMouseEnterListener(iframe);
    };

    this.deleteActiveIframes = function () {
        Array.from(document.querySelectorAll('img[' + attributes.proxyId + ']')).forEach(function (proxyImage) {
            var iframe = _this.getIframeForProxyImage(proxyImage);

            if (iframe) {
                _this.getDeleteHelper().deleteBlot(iframe);
            }
        });
    };

    this.getAlignmentHelper = function () {
        return _this.getImageResize().options.alignmentHelper;
    };

    this.getDeleteHelper = function () {
        return _this.getImageResize().options.deleteHelper;
    };

    this.isProxyImage = function (img) {
        return img.hasAttribute(attributes.proxyId);
    };

    this.removeMouseEnterListener = function (iframe) {
        return iframe.removeEventListener('mouseenter', _this.handleVideoMouseEnter);
    };

    this.addMouseEnterListener = function (iframe) {
        return iframe.addEventListener('mouseenter', _this.handleVideoMouseEnter);
    };

    this.observe = function (proxyImage) {
        return _this.proxyImageObserver.observe(proxyImage, { attributes: true });
    };

    this.getIframeForProxyImage = function (proxyImage) {
        return document.querySelector('iframe[' + attributes.proxyId + '=' + proxyImage.getAttribute(attributes.proxyId) + ']');
    };

    this.getProxyImageForIframe = function (iframe) {
        return document.querySelector('img[' + attributes.proxyId + '=' + iframe.getAttribute(attributes.proxyId) + ']');
    };

    this.getImageResize = function () {
        return _this.quill.getModule('imageResize');
    };

    this.removeProxyImages = function () {
        return Array.from(document.querySelectorAll('.' + _this.options.proxyImageClass)).forEach(function (proxy) {
            return proxy.remove();
        });
    };
...
/* harmony default export */ __webpack_exports__["a"] = (IframeResize);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_DisplaySize__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Toolbar__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_Resize__ = __webpack_require__(43);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ImageResize = function ImageResize(quill) {
    ...
    this.checkImage = function (evt) {
        if (_this.img) {
            if (evt.keyCode === 46 || evt.keyCode === 8) {
                _this.options.deleteHelper.deleteBlot(_this.img);
            }
            _this.hide();
        }
    };
...
/* harmony default export */ __webpack_exports__["a"] = (ImageResize);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AlignmentHelper__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DeleteHelper__ = __webpack_require__(17);



/* harmony default export */ __webpack_exports__["a"] = ({
	alignmentHelper: new __WEBPACK_IMPORTED_MODULE_0__AlignmentHelper__["a" /* default */](),
	deleteHelper: new __WEBPACK_IMPORTED_MODULE_1__DeleteHelper__["a" /* default */](),
...
var Resize = function (_BaseModule) {
    ...
    function Resize(resizer) {
        ...
        var _this = _possibleConstructorReturn(this, (Resize.__proto__ || Object.getPrototypeOf(Resize)).call(this, resizer));
    ...
    _createClass(Resize, [{
        ...
        value: function handleDrag(evt) {
            ...
            // update image size
            var deltaX = evt.clientX - this.dragStartX;
        ...
        value: function setCursor(value) {
            [document.body, this.img].forEach(function (el) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iframe_IframeResize__ = __webpack_require__(38);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "IframeResize", function() { return __WEBPACK_IMPORTED_MODULE_0__iframe_IframeResize__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__image_ImageResize__ = __webpack_require__(39);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ImageResize", function() { return __WEBPACK_IMPORTED_MODULE_1__image_ImageResize__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__ = __webpack_require__(10);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "AlignmentHelper", function() { return __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__DeleteHelper__ = __webpack_require__(17);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteHelper", function() { return __WEBPACK_IMPORTED_MODULE_3__DeleteHelper__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__image_modules_Toolbar__ = __webpack_require__(18);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Toolbar", function() { return __WEBPACK_IMPORTED_MODULE_4__image_modules_Toolbar__["a"]; });
