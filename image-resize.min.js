...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill_assets_icons_align_left_svg__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg__ = __webpack_require__(110);
...
var AlignmentHelper = function AlignmentHelper() {
    var _this = this;

    _classCallCheck(this, AlignmentHelper);

    this.clearStyles = function (el) {
        _this.floatStyle.remove(el);
        _this.marginStyle.remove(el);
        _this.displayStyle.remove(el);
    };

    this.clearData = function (el) {
        _this.alignAttribute.remove(el);
    };

    this.clear = function (el) {
        _this.clearStyles(el);
        _this.clearData(el);
    };

    this.getCurrentAlignment = function (el) {
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
            for (var _iterator = _this.getAlignments()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    this.alignments = [{
        ...
        apply: function apply(el) {
            _this.displayStyle.add(el, 'inline');
            _this.floatStyle.add(el, 'left');
            _this.marginStyle.add(el, '0 1em 1em 0');
            _this.alignAttribute.add(el, leftAlignName);
        },
        isApplied: function isApplied(el) {
            return _this.alignAttribute.value(el) === leftAlignName;
        }
    }, {
        icon: __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg___default.a,
        apply: function apply(el) {
            _this.displayStyle.add(el, 'block');
            _this.floatStyle.remove(el);
            _this.marginStyle.add(el, 'auto');
            _this.alignAttribute.add(el, centerAlignName);
        },
        isApplied: function isApplied(el) {
            return _this.alignAttribute.value(el) === centerAlignName;
        }
    }, {
        icon: __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg___default.a,
        apply: function apply(el) {
            _this.displayStyle.add(el, 'inline');
            _this.floatStyle.add(el, 'right');
            _this.marginStyle.add(el, '0 0 1em 1em');
            _this.alignAttribute.add(el, rightAlignName);
        },
        isApplied: function isApplied(el) {
            return _this.alignAttribute.value(el) === rightAlignName;
        }
    }];
};

/* harmony default export */ __webpack_exports__["a"] = (new AlignmentHelper());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DefaultOptions__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__ = __webpack_require__(15);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var IframeResize = function IframeResize(quill) {
    ...
    this.handleProxyImageMutations = function (mutations) {
        mutations.forEach(function (mutation) {
            ...
            } else if (mutation.attributeName === __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__["b" /* alignAttribute */]) {
    ...
    this.onProxyImageAlignChange = function (proxyImage, iframe) {
        var nextIframeAlignment = __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__["a" /* default */].getCurrentAlignment(proxyImage);
        __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__["a" /* default */].clear(iframe);

        if (nextIframeAlignment !== null) {
            nextIframeAlignment.apply(iframe);
        }

        __WEBPACK_IMPORTED_MODULE_2__AlignmentHelper__["a" /* default */].clearStyles(proxyImage);
        _this.repositionProxyImage(proxyImage);
...
/* unused harmony default export */ var _unused_webpack_default_export = (IframeResize);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DefaultOptions__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_DisplaySize__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_Toolbar__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Resize__ = __webpack_require__(40);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AlignmentHelper__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__BaseModule__ = __webpack_require__(9);
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		}, _this.onDestroy = function () {}, _this.onUpdate = function () {}, _this._addToolbarButtons = function () {
			var buttons = [];
			__WEBPACK_IMPORTED_MODULE_0__AlignmentHelper__["a" /* default */].getAlignments().forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					if (alignment.isApplied(_this.img)) {
						// If applied, unapply
						__WEBPACK_IMPORTED_MODULE_0__AlignmentHelper__["a" /* default */].clear(_this.img);
					} else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iframe_IframeResize__ = __webpack_require__(35);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "IframeResize", function() { return __WEBPACK_IMPORTED_MODULE_0__iframe_IframeResize__["IframeResize"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__image_ImageResize__ = __webpack_require__(36);
