...
var apply = __webpack_require__(17),
    ...
    customDefaultsMerge = __webpack_require__(66),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__alignments__ = __webpack_require__(111);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var IframeResize = function IframeResize(quill) {
    ...
    this.onProxyImageAlignChange = function (proxyImage, iframe) {
        var nextIframeAlignment = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__alignments__["c" /* getCurrentAlignment */])(proxyImage);
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__alignments__["b" /* clearAlignmentData */])(iframe);

        if (nextIframeAlignment !== null) {
            nextIframeAlignment.apply(iframe);
        }

        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__alignments__["d" /* clearAlignmentStyles */])(proxyImage);
        _this.repositionProxyImage(proxyImage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_DisplaySize__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_Toolbar__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Resize__ = __webpack_require__(39);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BaseModule__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__alignments__ = __webpack_require__(111);
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			var buttons = [];
			__WEBPACK_IMPORTED_MODULE_1__alignments__["a" /* default */].forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					if (alignment.isApplied(_this.img)) {
						// If applied, unapply
						__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__alignments__["b" /* clearAlignmentData */])(_this.img);
					} else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iframe_IframeResize__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__image_ImageResize__ = __webpack_require__(35);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill_assets_icons_align_left_svg__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg__ = __webpack_require__(109);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getCurrentAlignment; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return clearAlignmentStyles; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return clearAlignmentData; });
...
var Align = new Parchment.Attributor.Attribute('data-align', 'data-align');
...
var leftAlign = {
    ...
    isApplied: function isApplied(el) {
        return Align.value(el) === leftAlignName;
    }
};
...
var centerAlign = {
    ...
    isApplied: function isApplied(el) {
        return Align.value(el) === centerAlignName;
    }
};
...
var rightAlign = {
    ...
    isApplied: function isApplied(el) {
        return Align.value(el) === rightAlignName;
    }
};

var alignments = [leftAlign, centerAlign, rightAlign];

var getCurrentAlignment = function getCurrentAlignment(el) {
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;
...
var clearAlignmentStyles = function clearAlignmentStyles(el) {
    FloatStyle.remove(el);
    MarginStyle.remove(el);
    DisplayStyle.remove(el);
};

var clearAlignmentData = function clearAlignmentData(el) {
    clearAlignmentStyles(el);
    Align.remove(el);
};

/* harmony default export */ __webpack_exports__["a"] = (alignments);
