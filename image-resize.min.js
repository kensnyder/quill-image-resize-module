...
var IframeResize = function IframeResize(quill) {
    ...
    this.handleVideoMouseEnter = function (evt) {
        var proxyImage = _this.createProxyImage(evt.target);
    ...
    this.handleProxyImageMutations = function (mutations) {
        mutations.forEach(function (mutation) {
            ...
            if (mutation.attributeName === 'width') {
                ...
                _this.onProxyImageStyleChange(proxyImage, iframe);
            }
    ...
    this.onProxyImageStyleChange = function (proxyImage, iframe) {
        var currentAlignment = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__alignments__["c" /* getCurrentAlignment */])(proxyImage);
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__alignments__["b" /* clearAlignmentStyles */])(iframe);
			...
			__WEBPACK_IMPORTED_MODULE_1__alignments__["a" /* default */].forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					if (alignment.isApplied(_this.img)) {
						// If applied, unapply
						__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__alignments__["b" /* clearAlignmentStyles */])(_this.img);
					} else {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return clearAlignmentStyles; });
...
var leftAlign = {
    ...
    isApplied: function isApplied(el) {
        return FloatStyle.value(el) == 'left';
    }
};
...
var centerAlign = {
    ...
    isApplied: function isApplied(el) {
        return MarginStyle.value(el) == 'auto';
    }
};
...
var rightAlign = {
    ...
    isApplied: function isApplied(el) {
        return FloatStyle.value(el) == 'right';
    }
};
